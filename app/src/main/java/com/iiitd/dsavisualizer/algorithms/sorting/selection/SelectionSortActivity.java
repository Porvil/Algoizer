...
public class SelectionSortActivity extends AppCompatActivity {
    ...
    final int LAYOUT_LEFT = R.layout.controls_selection_sort;
    final int LAYOUT_RIGHT = R.layout.controls_selection_sort;
    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            public void onStopTrackingTouch(SeekBar seekBar) {
               if (selectionSort != null && isAutoPlay) {
                    ...
                    timer.schedule(new TimerTask() {
                        @Override
                        public void run() {
                            if (selectionSort.sequence.curSeqNo < selectionSort.sequence.size)
                                onForwardClick();
                            else {
                                isAutoPlay = false;
        ...
        btn_info.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(selectionSort != null) {
                    ...
                    btn_play.setImageDrawable(UtilUI.getDrawable(context, AppSettings.PLAY_BUTTON));
                    timer.cancel();
                    comparisons = String.valueOf(selectionSort.comparisons);
                }
        ...
        btn_generate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(isRandomArray){
                    selectionSort = new SelectionSort(context, ll_anim, arraySize);
                }
                else {
                    String customArray = et_customarray.getText().toString();
                    if(customArray != null || !customArray.isEmpty()){
                    ...
                    cl_psuedocode.postDelayed(new Runnable() {
                        ...
                        public void run() {
                            if(selectionSort != null){
                                ...
                                int div = width / selectionSort.arraySize;

                                for(int i = 0; i< selectionSort.arraySize; i++){
                                    int position = selectionSort.positions[i];
                                    int x = position*div;
                                    float v1 = x - selectionSort.views[i].getX();
                                    selectionSort.views[i].animate().translationXBy(v1).start();
                                }
                            }
                        }
                    }, 0);
    ...
    private void addPseudocode(){
        int sizeOfPseudocode = SelectionSortInfo.psuedocode.length;
        ...
        for(int i : SelectionSortInfo.boldIndexes){
    ...
    private void onForwardClick(){
        if (selectionSort != null) {
            ...
            final int curSeqNo = selectionSort.sequence.curSeqNo;
